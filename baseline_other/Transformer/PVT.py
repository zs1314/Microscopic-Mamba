...
@register_model
def pvt_tiny(num_classes,pretrained=False, **kwargs):
    model = PyramidVisionTransformer(num_classes=num_classes,
...
@register_model
def pvt_small(num_classes,pretrained=False, **kwargs):
    model = PyramidVisionTransformer(num_classes=num_classes,
        patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[8, 8, 4, 4], qkv_bias=True,
...
@register_model
def pvt_medium(num_classes,pretrained=False, **kwargs):
    model = PyramidVisionTransformer(num_classes=num_classes,
        patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[8, 8, 4, 4], qkv_bias=True,
...
@register_model
def pvt_large(num_classes,pretrained=False, **kwargs):
    model = PyramidVisionTransformer(num_classes=num_classes,
        patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[8, 8, 4, 4], qkv_bias=True,
...
if __name__ == '__main__':
    ...
    model = pvt_small(num_classes=1000).to('cuda')
