...
@register_model
def pcpvt_small_v0(num_classes,pretrained=False, **kwargs):
    model = CPVTV2(num_classes=num_classes,
...
@register_model
def pcpvt_base_v0(num_classes,pretrained=False, **kwargs):
    model = CPVTV2(num_classes=num_classes,
        patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[8, 8, 4, 4], qkv_bias=True,
...
if __name__ == '__main__':
    ...
    model = pcpvt_small_v0(num_classes=1000).to('cuda')
